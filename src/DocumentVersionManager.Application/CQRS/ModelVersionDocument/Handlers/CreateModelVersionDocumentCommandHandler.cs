...
{
    public  class CreateModelVersionDocumentCommandHandler  :  IRequestHandler<CreateModelVersionDocumentCommand, Result<GeneralFailure, Guid>>
    {
        ...
        public async Task<Result<GeneralFailure, Guid>> Handle(CreateModelVersionDocumentCommand request, CancellationToken cancellationToken)
        {
