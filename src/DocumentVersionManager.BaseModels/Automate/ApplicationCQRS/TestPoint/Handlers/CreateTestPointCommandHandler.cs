...
{
    public  class CreateTestPointCommandHandler  :  IRequestHandler<CreateTestPointCommand, Result<GeneralFailure, Guid>>
    {
        ...
        public async Task<Result<GeneralFailure, Guid>> Handle(CreateTestPointCommand request, CancellationToken cancellationToken)
        {
